...
var ShiftView = (_temp = _class = function (_Component) {
    _inherits(ShiftView, _Component);

    function ShiftView(props) {
        _classCallCheck(this, ShiftView);

        return _possibleConstructorReturn(this, (ShiftView.__proto__ || Object.getPrototypeOf(ShiftView)).call(this, props));
    }

    _createClass(ShiftView, [{
        key: 'render',
        value: function render() {
            ...
            var width = schedulerData.getShiftTableWidth() - 2;
            var paddingBottom = contentScrollbarHeight;
            var shiftList = renderData.map(function (item) {
                ...
                var slotItem = _react2.default.createElement(
                    'div',
                    {  className: 'overflow-text header2-text', style: { background: item.slotShift } },
                );
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'td',
                        { 'data-resource-id': item.slotId, style: { height: item.rowHeight,background: item.slotShift } },
                        //slotItem
                    )
                );
            });
