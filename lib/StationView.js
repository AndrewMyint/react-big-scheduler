...
var StationView = (_temp = _class = function (_Component) {
    _inherits(StationView, _Component);

    function StationView(props) {
        _classCallCheck(this, StationView);

        return _possibleConstructorReturn(this, (StationView.__proto__ || Object.getPrototypeOf(StationView)).call(this, props));
    }
    ...
    _createClass(StationView, [{
        ...
        value: function render() {
            ...
            var width = schedulerData.getStationTableWidth() - 2;
            var paddingBottom = contentScrollbarHeight;
            var stationList = renderData.map(function (item) {
                ...
                var slotItem = _react2.default.createElement(
                    'div',
                    { title: item.slotStation, className: 'overflow-text header2-text', style: { textAlign: "center" } },
                    a
                );
