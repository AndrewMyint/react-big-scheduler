...
var SchedulerData = function () {
    ...
    {
        key: 'getStationTableWidth',
        value: function getStationTableWidth() {
            if (this.showAgenda) return this.config.agendaResourceTableWidth;

            return this.viewType === _index.ViewTypes.Week ? this.config.weekStationTableWidth : this.viewType === _index.ViewTypes.Day ? this.config.dayStationTableWidth : this.viewType === _index.ViewTypes.Month ? this.config.monthStationTableWidth : this.viewType === _index.ViewTypes.Year ? this.config.yearStationTableWidth : this.viewType === _index.ViewTypes.Quarter ? this.config.quarterStationTableWidth : this.config.customStationTableWidth;
        }
    },
    {
        key: 'getShiftTableWidth',
        value: function getShiftTableWidth() {
            if (this.showAgenda) return this.config.agendaResourceTableWidth;

            return this.viewType === _index.ViewTypes.Week ? this.config.weekShiftTableWidth : this.viewType === _index.ViewTypes.Day ? this.config.dayShiftTableWidth : this.viewType === _index.ViewTypes.Month ? this.config.monthShiftTableWidth : this.viewType === _index.ViewTypes.Year ? this.config.yearShiftTableWidth : this.viewType === _index.ViewTypes.Quarter ? this.config.quarterShiftTableWidth : this.config.customShiftTableWidth;
        }
    }, 
    {
    ...
    },
       {
        ...
        key: 'updateEventColor',
        value: function updateEventColor(event, newColor) {
            this._detachEvent(event);
            event.bgColor = newColor;
            this._attachEvent(event);
            this._createRenderData();
        }
    }, {
        ...
        value: function _createInitRenderData(isEventPerspective, eventGroups, resources, headers) {
            ...
            return isEventPerspective ? eventGroups.map(function (eventGroup) {
                ...
                return {
                    ...
                    slotStation: resource.station,
                    slotShift: resource.shift,
                    rowHeight: 0,
                    headerItems: headerEvents
                };
            });
