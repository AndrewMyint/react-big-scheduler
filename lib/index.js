...
var _StationView = require('./StationView');


var _StationView2 = _interopRequireDefault(_StationView);

var _ShiftView = require('./ShiftView');


var _ShiftView2 = _interopRequireDefault(_ShiftView);
...
var Scheduler = (_temp = _class = function (_Component) {
    ...
    _createClass(Scheduler, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                middleCustomHeader1= _props.middleCustomHeader1,
                middleCustomHeader2= _props.middleCustomHeader2,
                middleCustomButton= _props.middleCustomButton,
            ...
            if (showAgenda) {
                ...
                var stationTableWidth = schedulerData.getStationTableWidth();
                var shiftTableWidth = schedulerData.getShiftTableWidth();
                ...
                var stationContentStyle = { overflowX: "auto", overflowY: "auto", width: stationTableWidth + resourceScrollbarWidth - 2, margin: '0px -' + contentScrollbarWidth + 'px 0px 0px' };
                var shiftContentStyle = { overflowX: "auto", overflowY: "auto", width: shiftTableWidth, margin: '0px -' + contentScrollbarWidth + 'px 0px 0px' };
                if (config.schedulerMaxHeight > 0) {
                    ...
                    stationContentStyle = _extends({}, stationContentStyle, {
                        maxHeight: config.schedulerMaxHeight - config.tableHeaderHeight
                    });
                    shiftContentStyle = _extends({}, shiftContentStyle, {
                        maxHeight: config.schedulerMaxHeight - config.tableHeaderHeight
                    });
                }

                var resourceName = schedulerData.isEventPerspective ? config.taskName : config.resourceName;
                var stationName = config.stationName;
                var shiftName = config.shiftName;
                tbodyContent = _react2.default.createElement(
                    'tr',
                    null,
                    _react2.default.createElement(
                        'td',
                        { style: { width: "10px", verticalAlign: 'top' } },
                        _react2.default.createElement(
                            'div',
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'tr',
                                                { style: { height: config.tableHeaderHeight,"backgroundColor": "#2C374D",color:"#FFFFFF"  } },
                            ...
                            _react2.default.createElement(
                                'div',
                                { style: shiftContentStyle, ref: this.schedulerResourceRef, onMouseOver: this.onSchedulerResourceMouseOver, onMouseOut: this.onSchedulerResourceMouseOut, onScroll: this.onSchedulerResourceScroll },
                                _react2.default.createElement(_ShiftView2.default, _extends({}, this.props, {
                    ...
                    _react2.default.createElement(
                        'td',
                        { style: { width: stationTableWidth, verticalAlign: 'top' } },
                        _react2.default.createElement(
                            'div',
                            { className: 'resource-view' },
                            _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { style: stationContentStyle, ref: this.schedulerResourceRef, onMouseOver: this.onSchedulerResourceMouseOver, onMouseOut: this.onSchedulerResourceMouseOut, onScroll: this.onSchedulerResourceScroll },
                                _react2.default.createElement(_StationView2.default, _extends({}, this.props, {
                                    contentScrollbarHeight: resourcePaddingBottom
                                }))
                            )
                        )
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { style: { overflow: "hidden", borderBottom: "1px solid #000000", height: config.tableHeaderHeight } },
                                _react2.default.createElement(
                                    'div',
    ...
    middleCustomHeader1: _propTypes.PropTypes.object,
    middleCustomHeader2: _propTypes.PropTypes.object,
    middleCustomButton: _propTypes.PropTypes.object,
